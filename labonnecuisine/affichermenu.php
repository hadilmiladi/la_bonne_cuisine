...
{	
	...
	echo '<td><a href=editmenu.php?identifiant='.$ligne["id"].'>Modifier</a></td>
        <td><a href=deletemenu.php?identifiant='.$ligne["id"].'>Supprimer</a></td>
...
echo "</table>";
         ...
         <br><center><a href="ajoutermenu.html">Ajouter Plat </a></center>
