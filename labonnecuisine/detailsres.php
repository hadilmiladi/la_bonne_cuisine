...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <?php
        echo "<br><br><table width='80%' align='center' cellpadding='20'>
<tr>
  <td>id:</td>
  <td>nom:</td>
  <td>email:</td>
...
$ligne = $resultat->fetch_assoc();
{
  ...
  echo '<td>'. $ligne["nombrepersonnes"] .'</td>';
  echo '<td>'. $ligne["message"] .'</td>';
  
  echo '<td><a href=editres.php?identifiant='.$ligne["id"].'>Modifier</a></td>
        <td><a href=deleteres.php?identifiant='.$ligne["id"].'>Supprimer</a></td>
...
<br><center><a href="afficherreservation.php">Liste de reservations</a></center>
<br>
