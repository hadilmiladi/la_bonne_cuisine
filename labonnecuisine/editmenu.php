...
$requete = "SELECT * FROM menu WHERE id=".$_GET['identifiant'];
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        ...
        <form action="confirmeditmenu.php?plat=<?php echo $ligne["id"];?>" method="post">

                <table align="center">

                <tr><td>Entrez le nom du plat:    </td>
                <td><input type="text" name="nom" value="<?php echo $ligne["nom"];?>"/></td></tr>

                <tr><td>Entrez le nouveau prix:  </td>
                <td><input type="text" name="prix" value="<?php echo $ligne["prix"];?>" /></td></tr>
      ...
      <br>
         <center><a href="affichermenu.php">Retour</a></center>
       </div>
    </section>
