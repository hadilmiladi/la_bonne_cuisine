...
$requete = "DELETE FROM client WHERE id=".$_GET['utilisateur'];

$resultat = $mysqli->query($requete) or die ($mysqli->error());
echo '<center>';
echo "<script>alert(' suppression faite avec succès');</script><br>";
echo '</center>';
?>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="menu.php">Notre Menu</a></li>
      ...
      <a href="seconnecter.html" class="book-a-table-btn scrollto">Se connecter</a>
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <div>
                  <a href="menu.php" class="btn-menu animate__animated animate__fadeInUp scrollto">Notre Menu</a>
  ...
  <footer id="footer">
    <div class="container">
      <h3>La Bonne Cuisine</h3>
            ...
            <a href="loginadmin.html">Admin</a><br><br>
