...
$requete = "SELECT * FROM contact WHERE id=".$_GET['identifiant'];
...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
<?php
echo "<table width='80%' align='center' cellpadding='20' >
<td></td>
<td></td>
<td></td>
	<td><font color='black'>Num</font></td>
	<td><font color='black'>E-mail</font></td>
	<td><font color='black'>Nom</font></td>
	<td><font color='black'>Sujet</font></td>
...
<td></td>
  <td>'. $ligne["id"] .'</td>';
	echo '<td>'. $ligne["email"] .'</td><td>'. $ligne["nom"] .'</td><td>'. $ligne["sujet"] .'</td><td>'. $ligne["message"] .'</td><td>
	</tr>';
	echo "</table>";
?>
<br><center><a href="reclamation.php">Liste des réclamations</a></center>
</div>
    </section>
