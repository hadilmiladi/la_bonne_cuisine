...
$requete = "SELECT * FROM reservations WHERE id=".$_GET['identifiant'];
...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <form action="confirmeditres.php?idres=<?php echo $ligne["id"];?>" method="post">
...
<tr><td>Entrez email:  </td>
<td><input type="email" name="email" value="<?php echo $ligne["email"];?>" /></td></tr>

<tr><td>Entrez téléphone: </td>
<td><input type="text" name="number" value="<?php echo $ligne["telephone"];?>"/></td></tr>

<tr><td>Entrez la date: </td>
<td><input type="text" name="date" value="<?php echo $ligne["date"];?>"/></td></tr>

<tr><td>Entrez le temps: </td>
<td><input type="text" name="temps" value="<?php echo $ligne["temps"];?>"/></td></tr>

<tr><td>Entrez le nombre de personnes: </td>
<td><input type="text" name="nombrep" value="<?php echo $ligne["nombrepersonnes"];?>"/></td></tr>

<tr><td>Entrez Le Message: </td>
<td><textarea name="message" placeholder="<?php echo $ligne["message"];?>" rows="10" cols="50"></textarea></td></tr>
...
<br>
<center><a href="afficherreservation.php">Liste de reservations</a></center>
      </div>
    </section>
