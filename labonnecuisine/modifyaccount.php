...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
<form action="submit_modif.php?user=<?php echo $ligne["id"];?>" method="post">
...
<tr><td>E-mail:  </td>
<td><input type="text" name="E-mail" value="<?php echo $ligne["email"];?>" /></td></tr>
<tr><td>Date de naissance:  </td>
<td><input type="date" name="date" value="<?php echo $ligne["Dnaiss"];?>" /></td></tr>
<tr><td>Mot de passe:  </td>
<td><input type="text" name="mot" value="<?php echo $ligne["password"];?>" /></td></tr>
<tr><td>Adresse:  </td>
<td><input type="text" name="adresse" value="<?php echo $ligne["adresse"];?>" /></td></tr>
<tr><td>Tel:  </td>
<td><input type="tel" name="phone" value="<?php echo $ligne["telephone"];?>" /></td></tr>
