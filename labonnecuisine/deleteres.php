...
$requete = "DELETE FROM reservations WHERE id=".$_GET['identifiant'];
...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
       <?php
        echo "Reservation supprimée avec succès!";
?>
<br><center>
<a href="afficherreservation.php">Liste de reservations</a>
</center>
<br>
      </div>
    </section>
