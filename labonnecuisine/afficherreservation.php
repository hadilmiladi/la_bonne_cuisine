...
{ 
  ...
  echo '<td><a href=detailsres.php?identifiant='.$ligne["id"].'>Détails</a></td>
        <td><a href=editres.php?identifiant='.$ligne["id"].'>Modifier</a></td>
...
echo "</table>";
?>  
<br><br><center><a href="inner-page.html">Acceuil</a></center><br>
