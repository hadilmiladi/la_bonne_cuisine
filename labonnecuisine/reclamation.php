...
echo "Les réclamations :";
echo "<br><br><table width='80%' cellpadding='20' align='center'>
<tr>
<td>Num</td>
<td>Sujet</td>
</tr>";
...
echo '<td><a href=detailsreclam.php?identifiant='.$ligne["id"].'>Détails</a></td>
<td><a href=deletereclam.php?identifiant='.$ligne["id"].'>Supprimer</a></td>
