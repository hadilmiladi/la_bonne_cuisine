...
<body>
  ...
  <main id="main">
   ...
   $q="SELECT * FROM client WHERE password='$pass'";
...
<?php
        ...
        echo  '<a href=modifierprofil.php?identifiant='.$t["password"].'> Modifier mon profil </a><br>
                    <a href=reservationclient.php?identifiant='.$t["telephone"].'> Mes réservations </a><br>
                              <a href=supp.php?utilisateur='.$t["id"].'> Supprimer compte</a><br>
                                        <a href="index2.html"> Quitter </a>'
