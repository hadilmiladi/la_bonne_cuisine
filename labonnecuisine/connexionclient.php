...
$requete = "SELECT * FROM client WHERE email='$username' and password='$password'";
...
<body>
  ...
  header("Location: index2.html"); }
         ...
         ?>
<br><br><center><a href="seconnecter.html">Essayer une autre fois</a></center>
<br><center><a href="index.html">Revenir à la page d'accueil</a></center>
