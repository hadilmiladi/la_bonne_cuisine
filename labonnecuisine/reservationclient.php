...
$requete = "SELECT * FROM reservations WHERE telephone=".$_GET['identifiant'];
...
{ 
  ...
  echo '
        <td><a href=editresclient.php?identifiant='.$ligne["id"].'>Modifier</a></td>
        <td><a href=deleteresclient.php?identifiant='.$ligne["id"].'>Supprimer</a></td>
