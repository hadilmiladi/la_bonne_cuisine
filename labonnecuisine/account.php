...
{	
  ...
  <td>'. $ligne["id"] .'</td>';
	...
	echo '<td><a href=detailsaccount.php?identifiant='.$ligne["id"].'>details</a></td>
		<td><a href=modifyaccount.php?identifiant='.$ligne["id"].'>modifier</a></td>
		<td><a href=deleteaccount.php?identifiant='.$ligne["id"].'>supprimer</a></td>
		
	</tr>';
}
echo "</table>";
?>
<br><center><a href="ajoutercompte.html">Ajouter compte </a></center>
